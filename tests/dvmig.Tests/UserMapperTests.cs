...
namespace dvmig.Tests
{
    public class UserMapperTests
    {
        ...
        public UserMapperTests()
        {
            ...
            _mapper = new UserMapper(_sourceMock.Object, _targetMock.Object, _loggerMock.Object);
        }
        ...
        public async Task MapUserAsync_MapsByInternalEmailAddress()
        {
            ...
            _targetMock.Setup(t => t.RetrieveMultipleAsync(It.Is<QueryByAttribute>(q => q.Attributes.Contains("internalemailaddress") && q.Values.Contains("test@example.com")), It.IsAny<CancellationToken>()))
        ...
        public async Task MapUserAsync_MapsByDomainName_WhenEmailNotFound()
        {
            ...
            var targetCollection = new EntityCollection(new[] { new Entity("systemuser", targetId) });
            var emptyCollection = new EntityCollection();

            _sourceMock.Setup(s => s.RetrieveAsync("systemuser", sourceId, It.IsAny<string[]>(), It.IsAny<CancellationToken>()))
                       .ReturnsAsync(sourceEntity);

            _targetMock.Setup(t => t.RetrieveMultipleAsync(It.Is<QueryByAttribute>(q => q.Attributes.Contains("internalemailaddress")), It.IsAny<CancellationToken>()))
                       .ReturnsAsync(emptyCollection);

            _targetMock.Setup(t => t.RetrieveMultipleAsync(It.Is<QueryByAttribute>(q => q.Attributes.Contains("domainname") && q.Values.Contains("domain\\user")), It.IsAny<CancellationToken>()))
                       .ReturnsAsync(targetCollection);
